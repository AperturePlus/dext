...
- 当**整页**明确属于上述被排除类别时，传入**空的 professors 数组**并把顶层 `exclusion_reason` 填为对应类别 code；判断保守，普通教师详情中出现“博士后经历、讲座经历、海外经历、兼职经历、财务管理研究方向”等履历、学科或研究文字不排除。
- 只有整页身份明确为博士后人员、客座/讲座教授、行业导师、外籍教师、兼职导师/教授等被排除人员子类时，才返回空数组和 `exclusion_reason`。
